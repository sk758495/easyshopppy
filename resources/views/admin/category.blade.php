                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> <a href="{{ url('admin/edit_category',$item->id) }}"><button class="btn btn-success">Edit</button></a>
                                            </td>
                                            <td><a href="{{ url('admin/delete_category',$item->id) }}"><button class="btn btn-danger">Delete</button></a>
                                            </td>
